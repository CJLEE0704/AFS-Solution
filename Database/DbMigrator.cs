...
namespace PipeBendingDashboard.Database
{
    public class DbMigrator
    {
        ...
        public DbMigrator(AppDbContext db) => _db = db;
...
SELECT {CurrentSchemaVersion}, NOW()
WHERE NOT EXISTS (SELECT 1 FROM schema_version WHERE version_no = {CurrentSchemaVersion});");
        }
    }
}
